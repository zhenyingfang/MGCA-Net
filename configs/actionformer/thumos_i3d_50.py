...
annotation_path = "/data/zhenying/code/OV_TAL/annotations/zs_data/split50/THUMOS14/split_9.json"
class_map = "/data/zhenying/code/OV_TAL/annotations/zs_data/split50/THUMOS14/category_idx_9.txt"
test_class_map = "/data/zhenying/code/OV_TAL/annotations/zs_data/split50/THUMOS14/category_idx_9_test.txt"
...
post_processing = dict(
    ...
    external_cls=dict(
        ...
        path="/data/zhenying/code/OV_TAL/annotations/clip_imgs/thumos_clip_score_b16.npy",
...
work_dir = "exps/thumos/actionformer_i3d_50"
