...
class ResizeDataset:
    def __init__(
        ...
        if real_class_map is not None:
            self.real_class_map = self.get_class_map(real_class_map)
            self.class_map_idx = []
            for clm in self.class_map:
                self.class_map_idx.append(self.real_class_map.index(clm))
